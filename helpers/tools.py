...
from .constants import MICUENTAWEB_CURRENCIES, MICUENTAWEB_PARAMS
...
def _micuentaweb_get_contrib():
    return MICUENTAWEB_PARAMS.get('CMS_IDENTIFIER') + u'_' + MICUENTAWEB_PARAMS.get('PLUGIN_VERSION') + u'/' + release.version
